function editDogById(dogId) {
    ...
    axios.get(`/api/sessions`).then((response) => {
        ...
        axios.get(`/api/pets/${dogId}`).then((response) => {
            ...
            const deleteLisiting = document.getElementById('deleteContainer')

            deleteLisiting.addEventListener('click', e =>{
                ...
                axios.delete(`/api/pets/user/dog/delete/${dogId}`).then(() => {
                    console.log('dog removed from database')
                    viewAllDogs()
